...
fun LauncherScreen(
    ...
    val launcherBlurEnabled by viewModel.launcherBlurEnable.collectAsStateWithLifecycle()
    ...
    LazyColumn(
        ...
        item {
            SettingsCard {
                ...
                SettingsToggleItem(
                    title = stringResource(id = R.string.launcher_blur_switch),
                    checked = launcherBlurEnabled,
                    onCheckedChange = { viewModel.setLauncherBlurEnabled(it) }
                )
...
private fun HeaderSection() {
    Column(
        ...
        Icon(
            painter = painterResource(id = R.drawable.ic_home_launcher),
